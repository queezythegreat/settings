...
" ------------------------------ "
    " Custom colors
    hi link MBENormal   ModeMsg
    hi link MBEChnaged  ModeMsg
...
"          Tab Settings          "
" ------------------------------ "
    " Highlight settings for tab line
    hi clear TabLine
    hi clear TabLineSel
...
"       NERDTree Settings        "
" ------------------------------ "
    " Highlight settings for NERDTree
    hi link treeFlag       Ignore
    hi link treeUp         Title

    hi link treeClosable   Type
    hi link treeOpenable   Title

    hi link treePart       Folded
    hi link treePartFile   Folded

    hi link treeHelpKey    Identifier
    hi link treeHelpTitle  Macro

    hi link treeToggleOn   Question
    hi link treeToggleOff  WarningMsg

    hi link treeHelpCommand Identifier
    hi link treeHelp       String

    hi link treeRO         WarningMsg
    hi link treeDirSlash   WarningMsg

    hi link treeLink       Macro
    hi link treeFile       Normal
    hi link treeDir        WarningMsg

    hi link treeExecFile   SpecialKey
    hi link treeCWD        Title
    hi link treeBookmark   Normal
    hi link treeBookmarksLeader Ignore
    hi link treeBookmarksHeader Statement
    hi link treeBookmarkName Identifier

" ------------------------------ "
"  Python Development Settings   "
" ------------------------------ "
    " Highlight settings for Python syntax
    let python_highlight_indent_errors = 0
    let python_highlight_space_errors = 0
    let python_highlight_all = 1

    hi link pythonImport    Title
    hi link pythonStatement Title

    hi link pythonRun    Comment
    hi link pythonCoding Comment 

    hi link pythonBuiltinObj    WarningMsg 
    hi link pythonBuiltinFunc   WarningMsg 
    hi link pythonStrFormatting WarningMsg 

    hi link pythonFunction  SpecialKey
