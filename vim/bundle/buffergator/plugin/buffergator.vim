...
function! s:NewBufferCatalogViewer()
    ...
    function! l:catalog_viewer.setup_buffer_keymaps() dict
        ...
        if !exists("g:buffergator_use_new_keymap") || !g:buffergator_use_new_keymap
            ...
            noremap <buffer> <silent> E          :<C-U>call b:buffergator_catalog_viewer.visit_target(!g:buffergator_autodismiss_on_select, 0, "")<CR>
            ...
            noremap <buffer> <silent> <CR>       :<C-U>call b:buffergator_catalog_viewer.visit_open_target(1, !g:buffergator_autodismiss_on_select, "")<CR>
            noremap <buffer> <silent> t          :<C-U>call b:buffergator_catalog_viewer.visit_open_target(0, !g:buffergator_autodismiss_on_select, "")<CR>
            noremap <buffer> <silent> s          :<C-U>call b:buffergator_catalog_viewer.visit_open_target(0, !g:buffergator_autodismiss_on_select, "vert sb")<CR>
            noremap <buffer> <silent> i          :<C-U>call b:buffergator_catalog_viewer.visit_open_target(0, !g:buffergator_autodismiss_on_select, "sb")<CR>
            noremap <buffer> <silent> o          :<C-U>call b:buffergator_catalog_viewer.visit_open_target(0, !g:buffergator_autodismiss_on_select, "tab sb")<CR>
    ...
    function! l:catalog_viewer.render_buffer() dict
        ...
        for l:tidx in range(len(self.tab_catalog))
            ...
            for widx in range(len(l:tabinfo))
                ...
                let tabindx = "". l:tidx+1 . ":"
                let subline = "[" . tabindx .  s:_format_filled(l:tabbufnum, 6-len(tabindx), 1, 0) . "] "
